...
def showHotKeyBoard():
    try:
        ...
        btnBackSlash = Button(root, text = '\\', bd = '5', fg = getFgCol(keyDict['\\']), bg = getBgCol(keyDict['\\']))
        ...
        btnTab = Button(root, text = 'tab', bd = '5', fg = getFgCol(keyDict['tab']), bg = getBgCol(keyDict['tab']))
        btnCaps = Button(root, text = 'caps lock', bd = '5', fg = getFgCol(keyDict['caps lock']), bg = getBgCol(keyDict['caps lock']))
        btnLShift = Button(root, text = 'shift', bd = '5', fg = getFgCol(keyDict['shift']), bg = getBgCol(keyDict['shift']))
        btnRShift = Button(root, text = 'shift', bd = '5', fg = getFgCol(keyDict['shift']), bg = getBgCol(keyDict['shift']))
        ...
        btnSpace = Button(root, text = 'space', bd = '5', fg = getFgCol(keyDict['space']), bg = getBgCol(keyDict['space']))
        btnEnter = Button(root, text = 'enter', bd = '5', fg = getFgCol(keyDict['enter']), bg = getBgCol(keyDict['enter']))
        ...
        btnR.place(x=35 + 4*buttonGap, y=10 + 2*buttonGap)
        btnT.place(x=35 + 5*buttonGap, y=10 + 2*buttonGap)
        btnY.place(x=35 + 6*buttonGap, y=10 + 2*buttonGap)
        btnU.place(x=35 + 7*buttonGap, y=10 + 2*buttonGap)
        btnI.place(x=35 + 8*buttonGap, y=10 + 2*buttonGap)
        btnO.place(x=35 + 9*buttonGap, y=10 + 2*buttonGap)
        btnP.place(x=35 + 9*buttonGap, y=10 + 2*buttonGap)
        btnSqBracetOpen.place(x=35 + 10*buttonGap, y=10 + 2*buttonGap)
        btnSqBracetClose.place(x=35 + 11*buttonGap, y=10 + 2*buttonGap)
        btnBackSlash.place(x=35 + 12*buttonGap, y=10 + 2*buttonGap)

        btnCaps.place(x=10, y=10 + 3*buttonGap)
        btnA.place(x=60, y=10 + 3*buttonGap)
        btnS.place(x=60 + buttonGap, y=10 + 3*buttonGap)
        btnD.place(x=60 + 2*buttonGap, y=10 + 3*buttonGap)
        btnF.place(x=60 + 3*buttonGap, y=10 + 3*buttonGap)
        btnG.place(x=60 + 4*buttonGap, y=10 + 3*buttonGap)
        btnH.place(x=60 + 5*buttonGap, y=10 + 3*buttonGap)
        btnJ.place(x=60 + 6*buttonGap, y=10 + 3*buttonGap)
        btnK.place(x=60 + 7*buttonGap, y=10 + 3*buttonGap)
        btnL.place(x=60 + 8*buttonGap, y=10 + 3*buttonGap)
        btnSemiColon.place(x=60 + 9*buttonGap, y=10 + 3*buttonGap)
        btnQuote.place(x=60 + 10*buttonGap, y=10 + 3*buttonGap)
        btnEnter.place(x=60 + 11*buttonGap, y=10 + 3*buttonGap)

        btnLShift.place(x=10, y=10 + 4*buttonGap)
        btnZ.place(x=85, y=10 + 4*buttonGap)
        btnX.place(x=85 + buttonGap, y=10 + 4*buttonGap)
        btnC.place(x=85 + 2*buttonGap, y=10 + 4*buttonGap)
        btnV.place(x=85 + 3*buttonGap, y=10 + 4*buttonGap)
        btnB.place(x=85 + 4*buttonGap, y=10 + 4*buttonGap)
        btnN.place(x=85 + 5*buttonGap, y=10 + 4*buttonGap)
        btnM.place(x=85 + 6*buttonGap, y=10 + 4*buttonGap)
        btnComma.place(x=85 + 7*buttonGap, y=10 + 4*buttonGap)
        btnDot.place(x=85 + 8*buttonGap, y=10 + 4*buttonGap)
        btnSlash.place(x=85 + 9*buttonGap, y=10 + 4*buttonGap)
